...
import 'package:charity_app/screens/team_view_result_screen.dart';
...
class TeamFundraiseCard extends StatefulWidget {
  final snap;

  const TeamFundraiseCard({
    super.key,
    required this.snap,
  });

  @override
  State<TeamFundraiseCard> createState() => _TeamFundraiseCardState();
}

class _TeamFundraiseCardState extends State<TeamFundraiseCard> {
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TeamViewResultScreen(
                            snap: widget.snap,
