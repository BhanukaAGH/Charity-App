...
import '../../screens/view_charity_result_screen.dart';

class MyCharityFundraiseCard extends StatefulWidget {
  final snap;

  const MyCharityFundraiseCard({
    super.key,
    required this.snap,
  });

  @override
  State<MyCharityFundraiseCard> createState() => _MyCharityFundraiseCardState();
}

class _MyCharityFundraiseCardState extends State<MyCharityFundraiseCard> {
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ViewCharityResultScreen(
                            snap: widget.snap,
