...
import '../widgets/common/org_dropdown.dart';

class CreateCharityFundraiseScreen extends StatefulWidget {
  final String fundraiseType;
  const CreateCharityFundraiseScreen({super.key, required this.fundraiseType});

  @override
  State<CreateCharityFundraiseScreen> createState() =>
      _CreateCharityFundraiseScreenState();
}

class _CreateCharityFundraiseScreenState
    extends State<CreateCharityFundraiseScreen> {
  ...
  String fundraiseOrganization = 'All';
  ...
  void _saveData({required String type, required String uid}) async {
    ...
    try {
      String res = await FundraiserMethods().createFundraise(
        ...
        Organization: fundraiseOrganization,
              ...
              Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    OrgDropdown(
                      label: 'Organization (raising the fund for)',
                      hintText: 'Organization (raising the fund for)',
                      withAsterisk: false,
                      selectValue: fundraiseOrganization,
                      onChanged: (String? value) {
                        setState(() {
                          fundraiseOrganization = value!;
                        });
                      },
                    ),
                    FormFieldInput(
