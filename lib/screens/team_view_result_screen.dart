import 'package:charity_app/screens/view_group_members_screen.dart';
import 'package:charity_app/utils/colors.dart';
import 'package:charity_app/utils/utils.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class TeamViewResultScreen extends StatelessWidget {
  final snap;
  final double raisedAmount;
  final int donationsCount;

  const TeamViewResultScreen({
    super.key,
    required this.snap,
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ViewGroupMembers(
                          MemberList: snap['membersList'],
                          fundraiseId: snap['fundraiseId'],
                          createdId: snap['uid']),
                    ));
              },
              child: Text(
